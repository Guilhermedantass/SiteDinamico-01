<section class="banner-conteiner">
    <div class="banner-single" style="background-image: url('<?php INCLUDE_PATH ?>images/bg-form.jpg');"></div>
    <div class="banner-single" style="background-image: url('<?php INCLUDE_PATH ?>images/bg-form2.jpg');"></div>
    <div class="banner-single" style="background-image: url('<?php INCLUDE_PATH ?>images/bg-form4.jpg');"></div>
